...
@section('content')
    ...
    @if (!empty($detail))
        <section class="relative w-full bg-white pt-24 overflow-hidden">
            ...
            <div class="container mx-auto  mb-6">
                <ol
                    class="inline-flex items-center space-x-1 md:space-x-3 bg-purple-50/50 rounded-lg p-4 text-sm text-gray-700 shadow-sm">
                    <li class="inline-flex items-center">
                        <a href="/"
                            class="text-sm text-gray-700 hover:text-purple-400 hover:font-semibold inline-flex items-center ">
                            <svg data-slot="icon" class="w-5 h-5 mr-2 text-purple-400 font-black" fill="none"
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="/product"
                                class="text-gray-700  ml-1 md:ml-2 text-sm font-medium  hover:text-purple-400 hover:font-semibold">Product</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-purple-400 ml-1 md:ml-2 text-sm font-medium dark:text-purple-500">
            ...
            <header class="bg-radial from-orange-100 via-red-100 to-zinc-300 py-20 mx-auto  mt-8 my-10">
                        ...
                        <div class="relative">
                            @if ($product->productDetails && $product->productDetails[0]->image)
                                <img src="{{ asset('storage/' . $product->productDetails[0]->image) }}"
                                    ...
                                    class="relative z-10 w-80 max-w-sm lg:max-w-md h-96 object-contain drop-shadow-2xl bg-single-product rounded-4xl p-4">
                            @else
                            ...
                            @endif
                            <div
                                class="absolute -bottom-8 -right-8 w-40 h-40 bg-purple-500 rounded-full opacity-30 blur-xl">
                            </div>
                            <div class="absolute top-0 -left-10 w-60 h-60 bg-indigo-500 rounded-full opacity-20 blur-2xl">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="hidden md:block lg:block lg:top-20 p-2 my-10 lg:my-0 w-full lg:w-1/3">
                                ...
                                <div class="flex flex-col gap-4 mt-4">
                                    @foreach ($productserupa as $item)
                                        <div
                                            class="flex flex-row w-full justify-start transition border border-gray-400 rounded-lg p-1">
    ...
    @else
        <div class="container mx-auto my-56 px-4 text-center">
            <h2 class="text-2xl font-semibold text-gray-700 mb-4">Produk Detail tidak ditemukan</h2>
